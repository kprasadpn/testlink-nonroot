...
function PostgresqlFunctions(opts) {
   ...
   * @param {string} [options.socket] - Database server socket
   * @example
   * // Insert a new row in the table 'companies' of 'postgres' database with values 'Bitnami, SF'
   ...
   * insert('postgres', 'companies', {'name': 'Bitnami', 'place': 'SF'}, {password: 'password123'});
   */
