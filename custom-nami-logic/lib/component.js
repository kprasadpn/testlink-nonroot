...
function componentFunctions(opts) {
   ...
   * // Result => /opt/bitnami/app/conf
   * //           /opt/bitnami/app/config -> /bitnami/app/conf
   */
  ...
  */
   ...
   */
  //kpfunction isProcessRunningAsRoot() {
    //kpreturn process.getuid() === 0;
  //kp}

  return {
    normalizeDirectories,
   //kp configurePermissions,
    printProperties,
    createExtraConfigurationFiles,
    validatePasswords,
    //kpisProcessRunningAsRoot,
  };
}
